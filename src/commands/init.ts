...
export default class Init extends Command {
  ...
  async run() {
    ...
    try {
      ...
      Object.assign(answers, await inquirer.prompt({
        type: 'input', name: 'wechatAppId', message: `${pc.green('微信')}小程序的AppId`,
      ...
      Object.assign(answers, await inquirer.prompt({
        ...
        message: `${pc.green('微信')}小程序的上传目录（相对路径）`,
        when: () => whenHasType(answers, 'wechat'),
        validate: validateInput,
      }))
      Object.assign(answers, await inquirer.prompt({
        ...
        message: `${pc.green('微信')}小程序代码上传的密钥（相对）路径`,
        when: () => whenHasType(answers, 'wechat'),
        validate: validateInput,
        default: function () {
      ...
      Object.assign(answers, await inquirer.prompt({
        ...
        message: `${pc.cyan('支付宝')}小程序的上传目录（相对路径）`,
        when: () => whenHasType(answers, 'alipay'),
        validate: validateInput,
      }))
      Object.assign(answers, await inquirer.prompt({
        ...
        message: `${pc.cyan('支付宝')}小程序代码上传的私钥（相对）路径`,
        when: () => whenHasType(answers, 'alipay'),
        default: function () {
